    ...
    var drawTable = function () {
      ...
      $.each(products, function () {
        ...
        $cartTable.append(
          ...
          '<td class="text-center" style="width: 30px;"><img width="20px" height="30px" src="' + this.image + '"/></td>' +
          '<td>' + this.name + '</td>' +
